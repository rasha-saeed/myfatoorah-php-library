...
clear; vendor/bin/phpcs --standard=PSR12 autoload.php --error-severity=10
clear; vendor/bin/phpcs --standard=PSR12 src/ --error-severity=10
clear; vendor/bin/phpcs --standard=PSR12 tests/ --error-severity=10
